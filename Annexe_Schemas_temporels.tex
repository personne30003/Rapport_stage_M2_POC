...
\end{align}
Le premier pas ($u^1$) doit être calculé soit avec la méthode d'Euler, soit avec la méthode RK2. Ce schéma comporte un mode parasite (mode computationnel). Pour le retirer, on y applique un filtre passe-bas (filtre d'Asselin) : 
\begin{align}
